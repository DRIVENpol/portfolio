 ...
 * @notice Pay a monthly subscription in erc20 tokens
 * @author Socarde Paul
 */
...
abstract contract SubscriptionInErc20 is Ownable {
    ...
    function withdrawErc20() external virtual onlyOwner {
        if(erc20Token.transfer(feeCollector, erc20Token.balanceOf(address(this))) == false) revert FailedErc20Transfer(); 
    }
